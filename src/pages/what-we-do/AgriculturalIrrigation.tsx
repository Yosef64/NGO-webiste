import { Droplets, Users, ArrowRight, Wheat, Sun } from "lucide-react";
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="">
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                Shalom Integrated Community Development (SICD) strengthens food
                security and climate resilience for farmers in Ethiopia’s
                drought-prone areas. Our program promotes sustainable farming
                and improves access to water through small-scale irrigation
                projects. By providing farmers with drought-resistant seeds and
                modern conservation training, we help them increase crop yields,
                diversify their income, and build a more stable future.
              </p>
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                Strategic partnerships are key to the program's success. SICD
                collaborates with government bodies, research institutes, and
                international partners to ensure our interventions are effective
                and scalable. This approach combines technical expertise with
                community-led management, creating sustainable solutions that
                empower local farmers and align with national development goals
